            ...
            return (
              ...
              >
                <button
                  ...
                  className="flex items-center pr-6 py-0.5 mr-0.5"
                >
                  <span className={`flex items-center gap-1.5 px-2.5 py-1 text-xs whitespace-nowrap rounded-t border-b-2 transition-colors ${
