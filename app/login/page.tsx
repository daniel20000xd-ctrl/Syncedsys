    ...
    <div className="min-h-screen bg-[#0079bf] flex items-center justify-center">
      <div className="bg-white rounded-lg p-8 w-full max-w-sm shadow-lg">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 border border-gray-300 rounded px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors mb-4"
        >
          <GoogleIcon />
        ...
        <p className="mt-4 text-center text-sm text-gray-600">
          ...
          <Link href="/signup" className="text-[#0079bf] hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  )
